...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/demo/approvergroups/test/integration/FirstJourney",
    "com/demo/approvergroups/test/integration/ApproverGroupListJourney",
    "com/demo/approvergroups/test/integration/ApproverGroupObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
